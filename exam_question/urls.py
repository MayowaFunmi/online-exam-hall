...
urlpatterns = [
    ...
    path('examiner_subject/', views.examiner_subject, name='examiner_subject'),
    path('check_question/', views.check_question, name='check_question'),
    path('view_examiner_questions/', views.view_examiner_questions, name='view_examiner_questions'),
    ...
    path('add_question/', ajax_views.CreateQuestion.as_view(), name='create_question'),
    path('get_question/', ajax_views.GetQuestions.as_view(), name='get_question'),
    path('student_question/', ajax_views.StudentQuestions.as_view(), name='student_question'),
    path('save_answer/', ajax_views.SaveAnswer.as_view(), name='save_answer'),
    path('subject_answered/', ajax_views.SubectAnswered.as_view(), name='subject_answered'),
    path('get_location/', ajax_views.GetLocation.as_view(), name='get_location'),

    path('examiner_question/', views.set_exam, name='examiner_question'),
