...
def select_subject(request):
    registered = ExamRegistration.objects.get(candidate=request.user)
    return render(request, 'students/select_subject.html', {'registered': registered})

'''
create function for rendering page for each question of each class 
if registered.subject_1 == 'Mathematics (MTH222)':
    return the url for the function for maths ss2
'''
