...
class Question(models.Model):
    id = models.AutoField(primary_key=True)
    registration = models.ForeignKey(ExaminerExamRegistration, on_delete=models.CASCADE, null=True)
    ...
    def __str__(self):
        return f"{self.id} {self.registration.subject.subject_name} ({self.registration.subject.subject_code})"
